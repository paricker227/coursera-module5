...
console.log("in addEventListener after buildAndShowHomeHTML = " + buildAndShowHomeHTML());
}
);
// *** finish **
...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      var chosenCategoryShortName = "1"; //chooseRandomCategory();
      ...
      var homeHtmlToInsertIntoMainPage = insertProperty(randomCategoryShortName,
                   "name",
                   chosenRandomCategory.category.name);
